...
class Symbol
{
	...
	public const CLF = 'CLF'; // Chilean Unit of Account (UF)
	...
	public const XAG = 'XAG'; // Silver (troy ounce)
	public const XAU = 'XAU'; // Gold (troy ounce)
	...
	public const ZMK = 'ZMK'; // Zambian Kwacha (pre-2013)
